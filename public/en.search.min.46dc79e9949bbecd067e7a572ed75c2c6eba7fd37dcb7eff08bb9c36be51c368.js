'use strict';(function(){const searchDataURL='/en.search-data.min.b60006101d94640e19c54a7de5b7c9cd94064b6c99f2e7e8043945b30eb58d1b.json';const indexConfig=Object.assign({cache:true},{doc:{id:'id',field:['title','content'],store:['title','href','section']}});const input=document.querySelector('#book-search-input');const results=document.querySelector('#book-search-results');if(!input){return}
